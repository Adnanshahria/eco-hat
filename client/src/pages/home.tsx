              ...
              {categories.map((category, index) => (
                ...
                >
                  <div className="bg-card rounded-2xl p-6 border border-card-border hover:border-primary/30 hover:shadow-lg transition-all duration-300">
                    ...
                    <h3 className="font-display font-semibold mb-1">{t(category.name)}</h3>
                    <p className="text-sm text-muted-foreground">{category.count} {t('nav.products').toLowerCase()}</p>
                  </div>
                </motion.div>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="frosted-glass rounded-2xl p-6 lg:p-10 hover:border-primary/30 transition-colors">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
              ...
              {/* CTO */}
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="bg-card p-6 rounded-2xl border border-card-border text-center hover:shadow-lg transition-shadow relative">
                <Popover>
                ...
                <p className="text-primary font-medium text-sm mb-3">{t('team.cto')}</p>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="bg-card p-6 rounded-2xl border border-card-border text-center hover:shadow-lg transition-shadow relative">
                <Popover>
                  <PopoverTrigger asChild>
                    <button className="absolute top-3 right-3 p-1 rounded-full bg-muted hover:bg-primary/20 text-primary/70 hover:text-primary transition-colors">
                      <HelpCircle className="h-4 w-4" />
                ...
                <p className="text-primary font-medium text-sm">{t('team.techMgmt')}</p>
                <p className="text-muted-foreground text-xs mb-3">{t('team.devOps')}</p>
